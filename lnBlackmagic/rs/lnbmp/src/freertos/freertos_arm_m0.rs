...
impl freertos_switch_handler for freertos_switch_handler_m0 {
    ...
    fn write_registers_to_stack(&mut self) -> bool {
        ...
        self.gpr.push(8, 12); // push  R8..r12 excluded
        self.gpr.push(4, 8); // push  R4..r8 excluded
    ...
    fn read_registers_from_addr(&mut self, address: u32) -> bool {
        ...
        self.gpr.pop(4, 8); // push  R4..r8 excluded
        self.gpr.pop(8, 12); // push  R8..r12 excluded
        self.gpr.pop(0, 4); //

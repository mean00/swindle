...
#define EXTRA_SETUP() { extern void lnExtiNoSWD();   lnPinMode(PA9, lnOUTPUT);    lnPinMode(PA10, lnOUTPUT);    lnPinMode(PB6, lnALTERNATE_PP);    lnPinMode(PB7, lnALTERNATE_PP);lnExtiNoSWD();}

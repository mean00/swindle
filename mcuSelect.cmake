...
IF(NOT DEFINED LN_ARCH)
  IF(USE_CH32V3x) # RISCV
    SET(LN_ENABLED_BOARDS CH32F1 RP2040 STM32F1  NRF51 NRF91 LPC11XX LPC15XX LPC17XX STM32F4 STM32G0 STM32H7 STM32H5   STM32L4 CACHE INTERNAL "")
    # try without crystal...
  ...
  ELSE()
    ...
    ELSE() # Small bluepill style
      ...
      SET(LN_ENABLED_BOARDS   CH32F1 RP2040 STM32F1 CACHE INTERNAL "")
